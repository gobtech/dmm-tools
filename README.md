...
- **Press Pickup**: Type an artist name + date range (7/14/28 days or custom From/To) → 7-source pipeline (RSS feeds, sitemaps, Google News, Brave, Serper, Tavily, DuckDuckGo) → AI relevance filter → smart social media classification (outlet posts included, artist/unknown excluded) → displays formatted report → downloadable .docx
